...
do
  ...
  echo VIEWING $f
  echo
  '/mnt/disks/disk-2/Tools/samtools-1.5/samtools' view -@ $THREADS -b -u -o $USORTPATH $f
  echo
  echo SORTING $USORTFILE
  echo
  '/mnt/disks/disk-2/Tools/samtools-1.5/samtools' sort -o $SORTPATH -@ $THREADS -m $MEM $USORTPATH
  rm $USORTPATH
done
